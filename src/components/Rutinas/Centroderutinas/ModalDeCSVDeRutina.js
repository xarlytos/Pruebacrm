...
import styles from './ModalDeCSVDeRutina.module.css';
...
const ModalDeCSVDeRutina = ({ show, onClose, onAddRoutine }) => {
  ...
  return (
    <Modal show={show} onHide={onClose} size="lg">
      <Modal.Header closeButton>
        <Modal.Title>Previsualización de CSV</Modal.Title>
      </Modal.Header>
      <Modal.Body>
        <Form>
          <Form.Group>
            ...
            <Form.Control
              ...
              style={{ display: 'none' }}
            />
            <Button onClick={handleUpload} className={styles.uploadButton} variant="success" style={{ marginTop: '10px' }}>Upload</Button>
...
export default ModalDeCSVDeRutina;
